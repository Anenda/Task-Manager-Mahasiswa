                ...
                <form action="{{ route('projects.update', $project->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="category" id="category" required>
                            <option {{ $project->category == "kuliah" ? "selected" : "" ; }} value="kuliah">Kuliah</option>
                            <option {{ $project->category == "proyek" ? "selected" : "" ; }} value="proyek">Proyek</option>
                            <option {{ $project->category == "pekerjaan" ? "selected" : "" ; }} value="pekerjaan">Pekerjaan</option>
                            <option {{ $project->category == "organisasi" ? "selected" : "" ; }} value="organisasi">Organisasi</option>
